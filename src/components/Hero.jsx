...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center p-8 relative overflow-hidden grid-bg">
      {/* Background Ambience */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-neon-purple/20 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 left-20 w-[400px] h-[400px] bg-neon-cyan/10 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="order-2 md:order-1 space-y-6">
          ...
          >
            <div className="inline-block px-3 py-1 border border-neon-cyan/50 rounded-full bg-neon-cyan/5 mb-4">
              <span className="font-mono text-neon-cyan text-xs tracking-wider">SYSTEM_READY</span>
            </div>
          ...
          >
            <button className="group relative px-6 py-3 bg-neon-pink text-black font-display text-xs tracking-wider hover:bg-white transition-colors">
            ...
            <button className="px-6 py-3 border border-white/20 hover:border-neon-cyan text-white font-display text-xs tracking-wider hover:text-neon-cyan transition-colors">
              CONTACT_ME
            </button>
          </motion.div>
        </div>
